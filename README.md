...
### ¡Hey! Soy Joan, Desarrollador Full Stack con foco en JavaScript y Python <br/>apasionado por la informática, el código limpio y las milanesas con papasfritas!

**JavaScript · TypeScript · React · Node.js · HTML · CSS · Bootstrap · Python · Flask · Django <br/> SQL · SQLAlchemy · APIs REST · Postman · Jest · Git · GitHub**
