...
Soy **desarrollador full stack** con experiencia en el **diseño, desarrollo y mantenimiento de aplicaciones web**. Me enfoco en crear **soluciones eficientes** y mantenerme en **aprendizaje continuo**.
Mi trayectoria incluye **soporte técnico**, **administración de sistemas** y **desarrollo de aplicaciones modernas**, lo que me brinda una visión completa del ciclo de vida de un proyecto.
Trabajo con **metodologías organizadas**, aplico **buenas prácticas** y aprovecho el potencial de la **IA** para mejorar los procesos de desarrollo.
